package jason.asSemantics.planning.planner.javagp;
...
public class JavaGPPlannerConverter implements PlannerConverter {
    ...
    /*
     * (non-Javadoc)
     * @see jason.asSemantics.planning.planner.PlannerConverter#executePlanner(jason.asSemantics.planning.planner.ProblemObjects, jason.asSemantics.planning.planner.StartState, jason.asSemantics.planning.planner.GoalState, jason.asSemantics.planning.planner.ProblemOperators, int)
     */
    public boolean executePlanner(ProblemObjects objects,
            StartState startState, GoalState goalState,
    ...
    /*
     * (non-Javadoc)
     * @see jason.asSemantics.planning.planner.PlannerConverter#executePlanner(jason.asSemantics.planning.planner.ProblemObjects, jason.asSemantics.planning.planner.StartState, jason.asSemantics.planning.planner.GoalState, jason.asSemantics.planning.planner.ProblemOperators, int, int)
     */
    public boolean executePlanner(ProblemObjects objects,
            StartState startState, GoalState goalState,
    ...
    /*
     * (non-Javadoc)
     * @see jason.asSemantics.planning.planner.PlannerConverter#getAgentSpeakPlan(boolean)
     */
