...
public class CallbackLogicalConsequence extends Agent {
    ...
    public CallbackLogicalConsequence(Agent epistemicAgent, LogicalConsequenceCallback callback) {
    ...
    public static CallbackLogicalConsequence CreateBBLogicalConsequence(Agent agent, BeliefBase other) {
        return new CallbackLogicalConsequence(agent, other::getCandidateBeliefs);
