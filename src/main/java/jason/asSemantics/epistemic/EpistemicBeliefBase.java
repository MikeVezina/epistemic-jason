 ...
 */
public class EpistemicBeliefBase extends BeliefBase implements Serializable {

    private static final long serialVersionUID = 4189725430351480996L;

    private static Logger logger = Logger.getLogger(EpistemicBeliefBase.class.getSimpleName());
    ...
    public void init(Agent ag, String[] args) {
        if (ag != null) {
            logger = Logger.getLogger(ag.getTS().getAgArch().getAgName() + "-"+ EpistemicBeliefBase.class.getSimpleName());
        }
    }
    ...
    public BeliefBase clone() {
        EpistemicBeliefBase bb = new EpistemicBeliefBase();
        for (Literal b: this) {
            bb.add(1, b.copy());
        }
        return bb;
